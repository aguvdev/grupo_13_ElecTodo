...
module.exports={    
    ...
    save : (req,res) => {
        const {id,image,name,module,price,discount,category} = req.body;
        ...
        fs.writeFileSync(path.join(__dirname,"..","data","productosHome.json"),JSON.stringify(productos,null,2),"utf-8")
        return res.redirect("/")
    },
